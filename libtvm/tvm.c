...
/* call	 */	case 0x17: stack_push(vm->pMemory, instr_idx); stack_push(vm->pMemory, instr_idx);
/* jmp	 */	case 0x16: *instr_idx = *arg0 - 1; break;
/* ret   */	case 0x18: stack_pop(vm->pMemory, instr_idx); stack_pop(vm->pMemory, instr_idx); break;
